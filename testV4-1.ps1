...
function Test-MoveIcons {
    ...
    $paths = @("C:\Program Files\Microsoft Office\root\Office 16\OUTLOOK.exe",
     "C:\Program Files\Microsoft Office\root\Office 16\WINWORD.exe",
     "C:\Program Files\Microsoft Office\root\Office 16\POWERPNT.exe",
     "C:\Program Files\Microsoft Office\root\Office 16\OneDrive.exe",
    ...
    for ($i=0; $i -lt 5 ;$i++) {
        ...
        if (Test-Path -Path $path) {
            ...
            Write-Host "Not working Try Again"
        }
